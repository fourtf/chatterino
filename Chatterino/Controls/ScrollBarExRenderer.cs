namespace CustomScrollBar
{
    ...
    internal static class ScrollBarExRenderer
    {
        ...
        {
            g.FillRectangle(App.ColorScheme.ScrollbarBG, rect);
        ...
        private static void DrawThumbVertical(
           ...
           ScrollBarState state)
        {
            g.FillRectangle(App.ColorScheme.ScrollbarThumb, rect);
        ...
        private static void DrawArrowButtonVertical(
           ...
           bool arrowUp)
        {
            g.FillRectangle(App.ColorScheme.ScrollbarArrow, rect);

            var image = !arrowUp ? Chatterino.Properties.Resources.ScrollBarArrowUp : Chatterino.Properties.Resources.ScrollBarArrowDown;

            g.DrawImage(image, rect.X + (rect.Width / 2 - image.Width / 2), rect.Y + (rect.Height / 2 - image.Height / 2));
